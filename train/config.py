...
class SearchConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--layers', type=int, default=2, help='# of layers')
        parser.add_argument('--seed', type=int, default=42, help='random seed')
        parser.add_argument('--workers', type=int, default=0, help='# of workers')
        # parser.add_argument('--alpha_lr', type=float, default=3e-2, help='lr for alpha')
        parser.add_argument('--alpha_lr', type=float, default=1e-2, help='lr for alpha')
    ...
    def __init__(self):
        ...
        self.data_path = './data/'
        self.path = os.path.join('searchs_2021', self.name)
...
class AugmentConfig(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--lr', type=float, default=0.001, help='lr for weights')
...
class comparisonConfig(BaseConfig):
    ...
    def __init__(self):
        ...
        self.data_path = './data/'
        self.path = os.path.join('comparision', self.name)
        self.gpus = parse_gpus(self.gpus)
